"""CortexDB MCP Server (DOC-017 Section 10, DOC-018 Gap G18)

CortexDB exposed as a Model Context Protocol server.
AI agents (Claude, LangGraph, OpenAI Agents) discover and use CortexDB as a tool.

Tools:
  cortexdb.query      - Execute CortexQL query
  cortexdb.write      - Write data with fan-out
