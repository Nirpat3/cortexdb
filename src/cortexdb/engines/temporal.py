...
class TemporalEngine(BaseEngine):
    ...
    async def write_heartbeat(self, node_id: str, grid_address: str,
        ...
        await self._with_reconnect("write_heartbeat", _do, reconnect_errors=self.RECONNECT_ERRORS)
    ...
    async def write_agent_metric(self, agent_id: str, metrics: Dict) -> None:
        ...
        await self._with_reconnect("write_agent_metric", _do, reconnect_errors=self.RECONNECT_ERRORS)
    ...
    async def query_heartbeats(self, node_id: str, hours: int = 24,
        ...
        return await self._with_reconnect("query_heartbeats", _do, reconnect_errors=self.RECONNECT_ERRORS)
